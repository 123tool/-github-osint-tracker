...
2. **​Clone Repositori**
```
git clone https://github.com/123tool/github-osint-tracker.git
cd github-osint-tracker
```
...
Segala bentuk penyalahgunaan yang melanggar ketentuan layanan (*Terms of Service*) dari platform pihak ketiga (GitHub, GitLab, Meta, Hunter.io) sepenuhnya merupakan tanggung jawab pengguna akhir.
